...
echo "$(bashio::config 'db_user')" > /etc/container_environment/DB_ROOT_USER
echo "$(bashio::config 'db_password')" > /etc/container_environment/DB_PASSWORD
echo "$(bashio::config 'db_password')" > /etc/container_environment/DB_ROOT_PASSWD
echo "$(bashio::config 'db_seafile_name')" > /etc/container_environment/SEAFILE_MYSQL_DB_SEAFILE_DB_NAME
echo "$(bashio::config 'db_ccnet_name')" > /etc/container_environment/SEAFILE_MYSQL_DB_CCNET_DB_NAME
...
echo "false" > /etc/container_environment/ENABLE_SEADOC
